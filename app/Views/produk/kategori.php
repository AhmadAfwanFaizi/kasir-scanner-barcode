        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="tabelKategoriProduk" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th>#</th>
                    ...
                    <form role="form">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="kategoriProduk" placeholder="Kategori Produk" autofocus>
                            </div>
                        </div>
                    </form>
                </div>
